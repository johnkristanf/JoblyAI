...
import { useInterviewWs } from '~/hooks/use-interview-ws'
...
export default function InterviewPage() {
    ...
    const { status, transcripts, endSession, error, isMicMuted, muteMic, unmuteMic, isSpeakerMuted, setSpeakerMuted } = useInterviewWs(jobTitle, employer)
