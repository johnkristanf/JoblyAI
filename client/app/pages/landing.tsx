      ...
      <nav className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="/auth/signup" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
              Get Started
            </a>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8">
              Get matched to opportunities that align with your skills, experience, and career goals. See onsite job locations on an interactive map.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Our AI analyzes your professional background, skills, and experience to find jobs that truly fit your career path.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Location Insights</h3>
              <p className="text-gray-600">
                View job locations on an interactive map to find opportunities near you or explore remote positions worldwide.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Personalized Matching</h3>
              <p className="text-gray-600">
                Get job recommendations tailored to your qualifications, preferences, and career aspirations in real-time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Share Your Profile</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our AI finds opportunities that align with your unique qualifications and career goals
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Explore Opportunities</h3>
              <p className="text-gray-600">
                Browse matched jobs with detailed descriptions and location maps to find your perfect fit
              </p>
            </div>
          </div>
        </div>
