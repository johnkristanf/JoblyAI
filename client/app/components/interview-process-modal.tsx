...
type InterviewProcessModalProps = {
    isOpen: boolean
    onClose: () => void
    process: string | null
    isLoading: boolean
            ...
            >
                ...
                <div className="flex items-start justify-between px-6 pt-5 pb-4 border-b border-gray-100">
                    <div>
                        ...
                        {jobTitle && (
                            <p className="text-sm text-indigo-600 mt-0.5 font-medium">{jobTitle}</p>
                        )}
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="overflow-y-auto px-6 py-5 flex-1">
                    {isLoading ? (
                        ...
                        <ReactMarkdown components={mdComponents}>{process}</ReactMarkdown>
                    ) : null}
                </div>
            </div>
        </div>
